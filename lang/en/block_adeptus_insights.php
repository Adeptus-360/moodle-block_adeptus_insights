...
$string['alert_threshold_exceeded_msg'] = 'Your {$a->report} has reached {$a->value}, exceeding your {$a->severity} threshold ({$a->threshold}).';
$string['alert_trend_decrease'] = '{$a->name} decreased by {$a->change} ({$a->percent}%) since last measurement.';
$string['alert_trend_increase'] = '{$a->name} increased by {$a->change} ({$a->percent}%) since last measurement.';
$string['alert_trend_stable'] = '{$a} has remained stable since last measurement.';
...
$string['error_send_email_exception'] = 'Error sending email to {$a->email}: {$a->error}';
$string['error_send_email_failed'] = 'Failed to send email to: {$a}';
$string['error_send_notification_exception'] = 'Error sending to user {$a->userid}: {$a->error}';
$string['error_send_notification_failed'] = 'Failed to send notification to user {$a}';
$string['error_snapshots_disabled'] = 'Snapshots feature is not enabled for this installation';
$string['error_user_not_found'] = 'User {$a} not found';
